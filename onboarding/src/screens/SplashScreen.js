	...
	return (
		<View style={styles.container}>
			...
			<View>
				<PageView
					onPageScroll={({ nativeEvent }) => {
						if (nativeEvent.position !== currentSlideNumber)
				...
				<View
					style={[styles.alignCenter, { marginTop: 10, flexDirection: "row" }]}
				>
					{pages.map((_, index) => (
			...
			<View style={styles.alignCenter}>
				<CustomButton
					buttonHandler={() => navigation.navigate("signup")}
					text={"Get Started"}
				/>
			</View>
		</View>
